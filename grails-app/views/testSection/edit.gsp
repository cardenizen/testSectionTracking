...
<%@ page import="us.mn.state.dot.area.County; us.mn.state.dot.testSectionTracking.TestSection" %>
<html>
  <head>
            ...
            <div id="Status">
              <table>
                <tbody>
                  ...
                  <tr class="prop">
                      <td valign="top" class="name">
                        <label for="groupname"><g:message code="testSection.groupname.label" default="Groupname" /></label>
                      </td>
                      <td valign="top" class="value ${hasErrors(bean:testSectionInstance,field:'groupname','errors')}">
                        <g:select name="groupname"
                          from="${groupnames.collect{it.encodeAsHTML()}}"
                          keys="${groupnames.collect{it.encodeAsHTML()}}"
                          value="${testSectionInstance.groupname?.encodeAsHTML()}"
                          noSelection="['':'']"
                          >
                        </g:select>
                        %{--<g:select name="groupname"--}%
                                 %{--from="${grailsApplication.config.groupnames}"--}%
                                 %{--value="${testSectionInstance.groupname}"--}%
                                 %{--noSelection="${['':'']}"--}%
                                 %{--/>--}%
                      </td>
                  </tr>
                  ...
                  <tr class="prop">
                      <td valign="top" class="name">
                        <label for="datestartconst"><g:message code="testSection.datestartconst.label" default="Date Start Construction" /></label>
                      </td>
                      <td valign="top" class="value ${hasErrors(bean:testSectionInstance,field:'datestartconst','errors')}">
                          <g:datePicker name="datestartconst"
                                  precision="day" years="${2020..1950}"
                  ...
                  <tr class="prop">
                      ...
                      <td valign="top" class="value ${hasErrors(bean:testSectionInstance,field:'keyword1','errors')}">
                        <g:select name="keyword1"
                                 from="${grailsApplication.config.keywords}"
                                 value="${testSectionInstance.keyword1}"
                                 noSelection="${['No Keyword':'No Keyword']}"
                                 />
                      </td>
                  </tr>
                  ...
                  <tr class="prop">
                      ...
                      <td valign="top" class="value ${hasErrors(bean:testSectionInstance,field:'keyword2','errors')}">
                        <g:select name="keyword2"
                                 from="${grailsApplication.config.keywords}"
                                 value="${testSectionInstance.keyword2}"
                                 noSelection="${['No Keyword':'No Keyword']}"
                                 />
                      </td>
                  </tr>
                  ...
                  <tr class="prop">
                      ...
                      <td valign="top" class="value ${hasErrors(bean:testSectionInstance,field:'keyword3','errors')}">
                        <g:select name="keyword3"
                                 from="${grailsApplication.config.keywords}"
                                 value="${testSectionInstance.keyword3}"
                                 noSelection="${['No Keyword':'No Keyword']}"
                                 />
                      </td>
                  </tr>
            ...
            <div id="Location">
              <table>
                  ...
                  <tr class="prop">
                      ...
                      <td valign="top" class="value ${hasErrors(bean:testSectionInstance,field:'system','errors')}">
                        <g:select name="system"
                          from="${systems.collect{it.encodeAsHTML()}}"
                          keys="${systems.collect{it.encodeAsHTML()}}"
                ...
                <g:select name="district"
                  from="${districts.collect{it.encodeAsHTML()}}"
                  keys="${districts.collect{it.encodeAsHTML()}}"
              ...
              <table>
                <tbody>
                  ...
                  <tr class="prop">
                      ...
                      <td valign="top" class="value ${hasErrors(bean:testSectionInstance,field:'contractor','errors')}">
                      ...
                      <td valign="top" class="name">
                        <label for="comments"><g:message code="testSection.comments.label" default="Comments" /></label>
                      </td>
                      <td  rowspan="2" valign="top" class="value ${hasErrors(bean:testSectionInstance,field:'comments','errors')}">
                          <textarea rows="2" cols="40" id="comments" name="comments">${fieldValue(bean:testSectionInstance, field:'comments')}</textarea>
                      </td>
                  </tr>
                  ...
                  <tr class="prop">
                      ...
                      <td valign="top" class="value ${hasErrors(bean:testSectionInstance,field:'layer1','errors')}">
                        <g:select name="layer1"
                                 from="${grailsApplication.config.layers}"
                                 value="${testSectionInstance.layer1}"
                                 noSelection="${['Not a Layer':'Not a Layer']}"
                                 />
                      </td>
                    <td>
                      <label for="l1comment"><g:message code="testSection.l1comment.label" default="Layer 1 Comment" /></label>
                    </td>
                  ...
                  <tr class="prop">
                      ...
                      <td valign="top" class="value ${hasErrors(bean:testSectionInstance,field:'layer2','errors')}">
                        <g:select name="layer2"
                                 from="${grailsApplication.config.layers}"
                                 value="${testSectionInstance.layer2}"
                                 noSelection="${['Not a Layer':'Not a Layer']}"
                                 />
                      </td>
                    <td valign="top" class="name">
                      <label for="l2comment"><g:message code="testSection.l2comment.label" default="Lyr 2 Comment" /></label>
                    </td>
                  ...
                  <tr class="prop">
                      ...
                      <td valign="top" class="value ${hasErrors(bean:testSectionInstance,field:'layer3','errors')}">
                        <g:select name="layer3"
                                 from="${grailsApplication.config.layers}"
                                 value="${testSectionInstance.layer3}"
                                 noSelection="${['Not a Layer':'Not a Layer']}"
                                 />
                      </td>
                      <td>
                        <label for="l3comment"><g:message code="testSection.l3comment.label" default="Lyr 3 Comment" /></label>
                      </td>
                  ...
                  <tr class="prop">
                      ...
                      <td valign="top" class="value ${hasErrors(bean:testSectionInstance,field:'layer4','errors')}">
                        <g:select name="layer4"
                                 from="${grailsApplication.config.layers}"
                                 value="${testSectionInstance.layer4}"
                                 noSelection="${['Not a Layer':'Not a Layer']}"
                                 />
                      </td>
                      <td>
                        <label for="l4comment"><g:message code="testSection.l4comment.label" default="Lyr 4 Comment" /></label>
                      </td>
                  ...
                  <tr class="prop">
                      <td valign="top" class="name">
                        <label for="l4thickness"><g:message code="testSection.l4thickness.label" default="L4thickness" /></label>
                      </td>
                  ...
                  <tr class="prop">
                      ...
                      <td valign="top" class="value ${hasErrors(bean:testSectionInstance,field:'layer5','errors')}">
                        <g:select name="layer5"
                                 from="${grailsApplication.config.layers}"
                                 value="${testSectionInstance.layer5}"
                                 noSelection="${['Not a Layer':'Not a Layer']}"
                                 />
                      </td>
                      <td>
                        <label for="l5comment"><g:message code="testSection.l5comment.label" default="Lyr 5 Comment" /></label>
                      </td>
